...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-newsweave-primary to-newsweave-secondary text-white py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <Button className="bg-white text-newsweave-primary hover:bg-white/90" onClick={handleConnectWallet}>
              {isConnected ? "Create Content" : "Connect Wallet"}
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="p-4 md:p-6 border rounded-lg bg-slate-50">
      ...
      {/* News Feed Section */}
      <section className="py-8 md:py-12 bg-newsweave-background">
        <div className="container mx-auto px-4">
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl md:text-3xl font-bold mb-3 md:mb-4">Join the NewsWeave Community</h2>
          <p className="text-newsweave-muted max-w-2xl mx-auto mb-6 md:mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="outline" className="border-newsweave-primary text-newsweave-primary" onClick={() => navigate("/how-it-works")}>
              Learn More
            </Button>
            <Button className="bg-newsweave-primary hover:bg-newsweave-primary/90" onClick={handleGetStarted}>
              Get Started
            </Button>
          </div>
        </div>
